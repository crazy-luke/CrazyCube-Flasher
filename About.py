...
<center>
    <h1>CrazyCube Flasher</h1>

    <p>Version {1}</p>

    <p>CrazyCube Flasher - &copy; 2022-2023 CrazyLuke. Licensed under MIT.</p>
    <p>Based on <a style="color: #004CE5;" href="https://github.com/marcelstoer/nodemcu-pyflasher">NodeMCU PyFlasher</a></p>
    <p>
...
'''
    ...
    def __init__(self, parent):
        wx.Dialog.__init__(self, parent, wx.ID_ANY, "About CrazyFlasher")
